#PURPOSE: This converts an input file to an output file with al letters converted to uppercase
...
#read-only flag
movl $O_RDONLY, %ecx
#this doesnt matter for reading
movl $0666, %edx
#call linux
int $LINUX_SYSCALL
